export const UserProfile = (props) => {
    const imgUrl = "https://www.pngkit.com/png/full/9-93510_movies-dwayne-the-rock-johnson-png.png"
    return (
        <tr>
            <td>
                <img src={props.imageUrl || imgUrl} alt='Viktor image' className="image"/>
            </td>
